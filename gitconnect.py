...
github_token = os.getenv('PAS')
print(git_token)
app = Flask(__name__)

# GitHub URL for your private JSON file
github_url = "https://raw.githubusercontent.com/DiegoAndresGlez/StudentChatbott/main/coursera_courses.json?token=GHSAT0AAAAAACH7V774XSJOZTF7BQGZGTQ2ZKMKSAA/chat"
